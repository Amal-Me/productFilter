...
//on importe le fichier avec ttes les datas des produits
...
const ProductList = () => {
  ...
  //récupère les valeurs de l input(composant search) a chaque changement
  ...
  useEffect(() => {
    //  filtre entre le titre de nos produits et l'input
    setFilteredProducts(
